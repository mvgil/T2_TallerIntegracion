...
class IngredientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingrediente" do
    assert_difference('Ingrediente.count') do
      post ingredientes_url, params: { ingrediente: { descripcion: @ingrediente.descripcion, nombre: @ingrediente.nombre } }
    end
  ...
  test "should update ingrediente" do
    patch ingrediente_url(@ingrediente), params: { ingrediente: { descripcion: @ingrediente.descripcion, nombre: @ingrediente.nombre } }
